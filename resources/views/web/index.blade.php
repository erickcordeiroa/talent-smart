...
<body>
    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto sm:px-4">
            <div class="flex justify-between h-auto px-4 md:px-0 py-6 items-center w-full">
                <div class="space-x-6">
                    <!-- Logo -->
                    <a href="/">
                        <img src="{{ asset('img/logo.png') }}" alt="Talent Smart" class="hidden md:block w-full max-w-sm">
                        <img src="{{ asset('img/icon.png') }}" alt="Talent Smart" class="block md:hidden w-16">
                    </a>
                </div>
    ...
    <section class="max-w-7xl px-2 md:px-0 mx-auto py-24">
        <div class="flex justify-between items-center space-x-4">
            <div class="information w-full md:w-1/2 space-y-6">
                <h6 class="font-bold uppercase text-sm text-blue-900 text-center md:text-left">Boas-vindas a TalentSmart
                </h6>
                <h1 class="text-6xl font-semibold text-center md:text-left">Encontre excelentes lugares para trabalhar
                </h1>
                <p class="text-lg text-gray-500 text-center md:text-left">Encontre suas vagas de emprego no Talent
    ...
    <section class="number_geral max-w-7xl  px-2 md:px-0 mx-auto ">
        <div
            class="number_geral_wapper flex-col py-10 bg-gray-100 rounded-xl md:flex-row flex justify-between items-center">
            <div class="md:border-r-2  md:border-b-0 border-blue-300 text-center py-6 px-32">
            ...
            <div class="md:border-l-2 md:border-t-0 border-blue-300 text-center py-6 px-32">
    ...
    <section class="services  py-24 max-w-screen-lg mx-auto">
        <div class="mb-10">
            ...
            <h2 class=" text-3xl md:text-4xl text-center font-bold">Como podemos ajuda-lo <br> a encontrar uma vaga ou candidato?
            </h2>
        </div>
        <div
            class="services-wrapper px-2 md:px-0 md:flex-row flex-wrap flex flex-col justify-between items-center space-y-8">

            <div
                class="services-wrapper-box border border-blue-400 px-6 py-10 rounded-xl shadow-sm w-full md:w-80 mt-10">
    ...
    <section class="about py-24 max-w-7xl mx-auto">
        <div class="about-wrapper flex flex-col md:flex-row flex-wrap justify-between items-center">
            ...
            <div class="about-wrapper-text w-full md:w-1/2 p-8">
                <p class="pt-6 pb-3 text-blue-500 uppercase text-center md:text-left">Sobre Nós</p>
                <h2 class="text-3xl md:text-4xl font-bold mb-4 text-center md:text-left">Entenda quem somos <br> e porque existimos</h2>
                <p class="text-gray-500 text-center md:text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione atque dolores
